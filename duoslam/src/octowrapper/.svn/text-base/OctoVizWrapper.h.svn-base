...
public:
    ...
    void addPC(octowrapper::point_cloud&, gl_color gc=getRed());
    void addPC(octowrapper::point_cloud&, octomap::pose6d& , gl_color gc=getRed());
    ...
    void addColorPC(octowrapper::color_point_cloud&);
    void addColorPC(octowrapper::color_point_cloud&, octomap::pose6d&);
