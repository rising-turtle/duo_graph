...
void ParameterServer::defaultConfig() {
  ...
  addOption("depth_scaling_factor",          static_cast<double> (0.1),                 "Some kinects have a wrongly scaled depth");
  ...
  addOption("depth_camera_fx",               static_cast<double> (525.0),                "Focal length w.r.t. horizontal pixel size. Use negative value to get from CameraInfo");
  addOption("depth_camera_fy",               static_cast<double> (525.0),                "Focal length w.r.t. vertical pixel size. Use negative value to get from CameraInfo");
  addOption("depth_camera_cx",               static_cast<double> (319.5),                "Horizontal image center. Use negative value to get from CameraInfo");
  addOption("depth_camera_cy",               static_cast<double> (239.5),                "Vertical image center. Use negative value to get from CameraInfo");
